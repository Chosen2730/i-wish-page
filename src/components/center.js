  ...
  return (
    <main className='text-gray-800 my-10 sm:mt-32'>
        ...
        <div className='grid sm:grid-cols-3 gap-8'>
          <div className='shadow-sm p-4'>
            <img
              ...
              alt='money'
            />
            <h5 className='font-bold text-xl my-3'>Create Wishlist</h5>
          ...
          <div className='shadow-sm p-4'>
            <img
              ...
              alt='money'
            />
            <h5 className='font-bold text-xl my-3'>Gift Boxing</h5>
            <p className='text-sm font-semibold'>
              An intuitive gift-sharing app made for users to get what they love
              and desire by simply wishing for it. Made for gifters and wishers!
            </p>
          ...
          <div className='shadow-sm p-4'>
            <img
              ...
              alt='money'
            />
            <h5 className='font-bold text-xl my-3'>Send money </h5>
            <p className='text-sm font-semibold'>
              An intuitive gift-sharing app made for users to get what they love
              and desire by simply wishing for it. Made for gifters and wishers!
            </p>
      ...
      <div className='my-10 mt-16'>
        <h1 className='text-3xl font-extrabold shadow-sm text-center my-5 capitalize'>
          How it works
        </h1>
